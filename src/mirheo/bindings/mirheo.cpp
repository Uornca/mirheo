...
void exportMirheo(py::module& m)
{
    ...
    py::handlers_class<Mirheo>(m, "Mirheo", R"(
        ...
        .def(py::init( [] (int3 nranks, real3 domain, double bufferSize,
                           ...
                           bool cudaMPI, bool noSplash, long commPtr, UnitConversion units)
            {
                ...
                if (commPtr == 0) {
                    return std::make_unique<Mirheo> (      nranks, domain, bufferSize, logInfo,
                    ...
                    return std::make_unique<Mirheo> (comm, nranks, domain, bufferSize, logInfo,
                                                           checkpointInfo, cudaMPI, units);
                }
            } ),
             py::return_value_policy::take_ownership,
             "nranks"_a, "domain"_a, "bufferSize"_a, "log_filename"_a="log", "debug_level"_a=3,

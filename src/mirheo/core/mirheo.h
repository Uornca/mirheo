...
public:
     ...
     */
    Mirheo(int3 nranks3D, real3 globalDomainSize, double bufferSize,
     ...
     */
    Mirheo(MPI_Comm comm, int3 nranks3D, real3 globalDomainSize, double bufferSize,
           LogInfo logInfo, CheckpointInfo checkpointInfo, bool gpuAwareMPI=false,
           UnitConversion units = UnitConversion());
...
private:
    ...
    void init(int3 nranks3D, real3 globalDomainSize, double bufferSize, LogInfo logInfo,

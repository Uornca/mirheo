...
void Mirheo::init(int3 nranks3D, real3 globalDomainSize, double bufferSize, LogInfo logInfo,
                  ...
                  UnitConversion units, LoaderContext *load)
{
    ...
    if (noPostprocess_)
    {
        ...
        state_ = std::make_shared<MirState> (createDomainInfo(cartComm_, globalDomainSize, bufferSize),
                           ...
                           LogInfo logInfo, bool gpuAwareMPI)
{
    ...
    init(nranks3D, mirState["domainGlobalSize"], mirState["bufferSize"], logInfo,
...
Mirheo::Mirheo(int3 nranks3D, real3 globalDomainSize, double bufferSize,
               ...
               UnitConversion units)
{
    ...
    init(nranks3D, globalDomainSize, bufferSize, logInfo, checkpointInfo, gpuAwareMPI, units);
}

Mirheo::Mirheo(MPI_Comm comm, int3 nranks3D, real3 globalDomainSize, double bufferSize,
               LogInfo logInfo, CheckpointInfo checkpointInfo, bool gpuAwareMPI,
               UnitConversion units)
{
